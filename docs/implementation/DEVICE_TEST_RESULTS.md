...
| 8 | Parent Progress updates after student work | 🔄 | Ready to test. Bé Lớp 4 now has 2 completed assignments from Test 7 (GAP_REPAIR + CHALLENGE); API confirms parent `/progress` returns `frontierInsight`, a knowledge-axis row, `recentEvidence: 1`. Parent home/progress/practice now refetch on focus (`ab09201`). | — | `ab09201` |
