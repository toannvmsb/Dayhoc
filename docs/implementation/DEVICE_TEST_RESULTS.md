...
| 9 | Teacher login (`giaovien@dayzi.seed`) | 🔄 | Seed already links teacher "Cô Pilot" ↔ *Bé Lớp 7* (accepted, with VIEW_LEARNING_TWIN_SUMMARY + VIEW_SELECTED_GAPS grants). Login → lands on "Học sinh", `/teacher/children` returns Bé Lớp 7. Ready to test. | — | — |
