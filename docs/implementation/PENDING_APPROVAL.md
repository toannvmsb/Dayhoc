...
> Migration v1.1: **A ✅ · B1+B2+B3 ✅ · pace ✅ · C1+C2+C3 ✅ · C3.1 ✅ · C4 ✅ · C4.1 ✅ · C4.2 ✅ · C5 (SHADOW MODE) ✅ (446 test / 5 skip, KHÔNG chạy live AI, LIVE mode CHƯA bật)**.
> **⚠ ĐANG CHỜ ANH DUYỆT C5 (chạy benchmark Luna khi có key) trước khi flip sang LIVE.
...
- **C5b+ ⏸ — CHƯA BẮT ĐẦU** (đợi anh cấp key → chạy benchmark Luna → anh duyệt): flip `AI_GENERATION_MODE=LIVE`, `buildDailyPlan` emit spec, thay `buildAssignmentsForPlan`, xoá bank path cũ, Interactive Adaptive Mode (C6), Next Best Question production, benchmark Terra vs Sonnet từ hard-case của Luna.
