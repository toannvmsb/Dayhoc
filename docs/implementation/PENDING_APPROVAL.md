...
> Migration v1.1: **A ✅ · B1+B2+B3 ✅ · pace ✅ · C1+C2+C3 ✅ · C3.1 ✅ · C4 ✅ · C4.1 ✅ · C4.2 ✅ (415 test xanh, KHÔNG có live AI)**.
> **⚠ ĐANG CHỜ ANH DUYỆT C4.2 trước khi bắt đầu C5 (flip practice runtime) trở đi.
...
- **C5+ ⏸ — CHƯA BẮT ĐẦU** (đợi anh APPROVE C4.2): `LunaExerciseGenerator` live, flip practice runtime, xoá bank path cũ, Interactive Adaptive Mode, Next Best Question production.
