    ...
    function writeReport() {
      ...
      writeFileSync(
        ...
        [
          ...
          `3.  kernel deterministic correctness: ${pct(kernelProdReady, kernelReady)}  (${kernelProdReady}/${kernelReady} of ${kernelItems} kernel items)   kernel wrong: ${kernelWrong}`,
          ...
          `8.  retry rate:                       ${(retries / Math.max(1, items)).toFixed(2)} / item  (${retries} retries, ${fallbackCalls} fallback calls)`,
